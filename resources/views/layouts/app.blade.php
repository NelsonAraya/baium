...
<head>
    ...
    <script src="{{ asset('plugins/tablejson/jquery.tabletojson.js') }}"></script>
    ...
    <link rel="icon" type="image/png" sizes="192x192"  href="/{{ asset('assets/faviconandroid-icon-192x192.png') }}">
